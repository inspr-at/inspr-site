...
if [ "${SKIP_PROBE:-}" = "1" ]; then
  ...
  probe_page "Paimos microsite" "https://paimos.inspr.at/" "Paimos" "text/html"
  probe_page "Pharos microsite" "https://pharos.inspr.at/" "Pharos" "text/html"
  probe_page "Janus microsite" "https://janus.inspr.at/" "Janus" "text/html"
  probe_page "v1 archive" "https://v1.inspr.at/" "INSPR" "text/html"
