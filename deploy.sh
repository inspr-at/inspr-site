...
if [ "${SKIP_PROBE:-}" = "1" ]; then
  ...
  probe_page "INSPR overview details switch" "https://www.inspr.at/overview/" "data-details-toggle" "text/html"
  probe_page "INSPR German overview details switch" "https://www.inspr.at/de/ueberblick/" "data-details-toggle" "text/html"
